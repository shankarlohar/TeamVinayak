package com.shankarlohar.teamvinayak.ui.signup
...
//        for (property in ConsentToExercise::class.memberProperties) {
//            RowWithCheckbox(
//                text = property.name,
//                isChecked = property.get(consentToExercise) as Boolean
//            ) {
//                property.set(consentToExercise, it)
//            }
//        }

        Button(
            onClick = { onNext(consentToExercise) },
